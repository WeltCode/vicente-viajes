...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#e8efec] px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto grid min-h-[88vh] w-full max-w-5xl overflow-hidden rounded-3xl border border-white/60 bg-white/70 shadow-[0_30px_80px_rgba(16,42,43,0.16)] backdrop-blur-xl lg:grid-cols-[1.15fr_1fr]">
        ...
        <div className="flex items-center justify-center p-5 sm:p-8 lg:p-12">
          <form onSubmit={handleSubmit} className="w-full max-w-md">
            <div className="mb-7 text-center lg:text-left">
              <h2 className="font-display text-4xl font-semibold text-[#152530]">Bienvenido</h2>
              <p className="mt-2 text-sm text-[#5f7170]">Inicia sesion para entrar al panel de administracion.</p>
            </div>
            ...
            <div className="mb-4 flex items-center gap-2 rounded-xl border border-[#ccdbd7] bg-[#eef3f1] px-3 focus-within:border-[#1f7770]">
              ...
              <input
                ...
                className="h-12 w-full bg-transparent text-sm text-[#152530] outline-none placeholder:text-[#8ea09d]"
            ...
            <div className="mb-6 flex items-center gap-2 rounded-xl border border-[#ccdbd7] bg-[#eef3f1] px-3 focus-within:border-[#1f7770]">
            ...
            <button
              ...
              className="group w-full rounded-xl bg-gradient-to-r from-[#1f7770] to-[#3f9b90] py-3 text-sm font-semibold text-white shadow-[0_8px_25px_rgba(31,119,112,0.35)] transition hover:translate-y-[-1px] hover:shadow-[0_12px_28px_rgba(31,119,112,0.45)] disabled:cursor-not-allowed disabled:opacity-80"
            >
