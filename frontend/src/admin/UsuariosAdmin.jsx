            ...
            <article key={`mobile-${user.id}`} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-sm text-slate-500">{displayName(user)}</p>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="inline-flex flex-1 items-center justify-center gap-1 rounded-md border border-rose-200 px-2.5 py-2 text-xs font-semibold text-rose-700 hover:bg-rose-50"
                >
                  <Trash2 size={14} />
                  Eliminar
                </button>
